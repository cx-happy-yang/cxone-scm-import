...
if __name__ == '__main__':
    ...
    cxone_github_app_auth_code = os.getenv("CXONE_GITHUBAPP_AUTH_CODE")
        ...
        if org_repo_name in project_name_list:
            ...
            try:
                ...
                update_repo_by_id(repo_id=project.repo_id, project_id=project_id, pay_load={
                    ...
                    "scaAutoPrEnabled": repo.get("scaAutoPrEnabled"),
    ...
    if github_org and cxone_github_app_auth_code:
        batch_import_repo(
            ...
            scan_ast_project=True,
            auth_code=cxone_github_app_auth_code,
            webhook_enabled=True, 
            pr_decoration_enabled=True, 
            sca_auto_pr_enabled=True,
            chunk_size=200,
            delay_request_timeout=30,
        )
